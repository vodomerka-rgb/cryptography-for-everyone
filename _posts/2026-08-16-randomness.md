...
### Overall, a system needs unpredictability, sufficient entropy, and a properly designed generator. Ordinary PRNGs are fast and useful for non-security applications, while CSPRNGs and physical sources of randomness are necessary when randomness serves a security function. 
